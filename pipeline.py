...
VERSION = '20210304.03'
USER_AGENT = 'Mozilla/5.0 (Windows NT 6.3; Win64; x64; rv:86.0) Gecko/20100101 Firefox/86.0'
TRACKER_ID = 'ge-tt'
...
LUA_SHA1 = get_hash(os.path.join(CWD, 'ge-tt.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'id':
                wget_args.extend(['--warc-header', 'ge.tt-id: '+item_value])
                wget_args.append('http://api.ge.tt/1/shares/'+item_value)
            else:
...
project = Project(
    title = 'ge-tt',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://wiki.archiveteam.org/images/c/c7/Ge.tt-logo.png" height="50px"/>
    <h2>ge.tt <span class="links"><a href="https://ge.tt/">Website</a> &middot; <a href="http://tracker.archiveteam.org/ge-tt/">Leaderboard</a></span></h2>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://{}/{}/multi={}/'
        ...
        downloader, VERSION),
    PrepareDirectories(warc_prefix='ge-tt'),
    WgetDownload(
        WgetArgs(),
        max_tries=1,
